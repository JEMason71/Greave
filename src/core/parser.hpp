...
private:
    enum class ParserCommand : uint16_t { NONE, ABILITIES, ADD_MONEY, ATTACK, CAREFUL_AIM, CLOSE, DIRECTION, DRINK, DROP, EAT, EQUIP, EQUIPMENT, EXAMINE, EXCLAIM, EXITS, EYE_FOR_AN_EYE, GO, GRIT, HASH, HELP, INVENTORY, LADY_LUCK, LOCK, LOOK, MIXUP, MIXUP_BIG, NO, OPEN, PARTICIPATE, QUICK_ROLL, RAPID_STRIKE, SAVE, SCORE, SKILLS, SPAWN_ITEM, SPAWN_MOBILE, STANCE, STATUS, SWEAR, TAKE, TELEPORT, TIME, UNEQUIP, UNLOCK, VOMIT, WAIT, WEATHER, XYZZY, YES, QUIT };
