...
private:
    enum class ParserCommand : uint16_t { NONE, CLOSE, DIRECTION, DROP, EQUIP, EQUIPMENT, GO, HASH, INVENTORY, LOCK, LOOK, NO, OPEN, SAVE, SPAWN_ITEM, SWEAR, TAKE, TELEPORT, TIME,
        UNEQUIP, UNLOCK, WAIT, WEATHER, XYZZY, YES, QUIT };
