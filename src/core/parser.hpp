...
private:
    enum class ParserCommand : uint16_t { NONE, ADD_MONEY, ATTACK, CLOSE, DIRECTION, DRINK, DROP, EAT, EQUIP, EQUIPMENT, EXAMINE, EXITS, GO, HASH, HELP, INVENTORY, LOCK, LOOK, MIXUP, MIXUP_BIG, NO, OPEN, SAVE, SCORE, SKILLS, SPAWN_ITEM, SPAWN_MOBILE, STANCE, STATUS, SWEAR, TAKE, TELEPORT, TIME, UNEQUIP, UNLOCK, WAIT, WEATHER, XYZZY, YES, QUIT };
