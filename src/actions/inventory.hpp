...
public:
    ...
    static void drop(std::shared_ptr<Mobile> mob, size_t item_pos);     // Drops an item on the ground.
    ...
    static void take(std::shared_ptr<Mobile> mob, size_t item_pos);     // Takes an item from the ground.
