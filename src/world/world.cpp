...
const std::map<std::string, ItemTag> World::ITEM_TAG_MAP = { { "ammoarrow", ItemTag::AmmoArrow }, { "ammobolt", ItemTag::AmmoBolt }, { "discardwhenempty", ItemTag::DiscardWhenEmpty }, { "handandahalf", ItemTag::HandAndAHalf }, { "noa", ItemTag::NoA }, { "noammo", ItemTag::NoAmmo }, { "offhandonly", ItemTag::OffHandOnly }, { "pluralname", ItemTag::PluralName }, { "preferoffhand", ItemTag::PreferOffHand }, { "propernoun", ItemTag::ProperNoun }, { "stackable", ItemTag::Stackable }, { "twohanded", ItemTag::TwoHanded } };
